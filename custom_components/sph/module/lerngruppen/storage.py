...
STORE_VERSION = 1
STORE_KEY_PREFIX = "sph_lerngruppen_manual"


class SphLearningGroupsManualStore:
    """Persist manually added Lerngruppen appointments independently of SPH updates."""
    ...
    async def async_add(self, item: dict) -> dict:
        ...
        stored["uid"] = str(stored.get("uid") or f"sph-lerngruppen-{stored['id']}")
